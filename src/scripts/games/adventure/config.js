...
const BOSSES=[
 ...
 {emoji:'🧛',name:'Nocturne Dơi Nhỏ Ánh Trăng',hp:360,minQ:11,atk:21,tier:3,time:20,arena:'night',mech:'drain',mechTxt:'✨ Khi đánh trúng, Nocturne hồi một phần máu',proj:'🦇',
 ...
 {emoji:'🧙',name:'Lumiel Pháp Sư Rừng Nấm',hp:560,minQ:14,atk:26,tier:5,time:19,arena:'night',mech:'heal', mechTxt:'💚 Phép hồi máu: mỗi lần em sai Lumiel hồi 10 máu',proj:'✨',
 ...
 {emoji:'🐙',name:'Leviator Bạch Tuộc Ngọc Trai',hp:640,minQ:15,atk:28,tier:5,time:19,arena:'ice',  mech:'drain',mechTxt:'✨ Leviator hồi máu khi đánh trúng; thử thách mạnh hơn ở giai đoạn 2',proj:'🌊',
